...
<?php
    ...
    include('config.php');
?>
    <title>Form Konfirmasi Peminjaman Offline</title>
    </head>
    <body>
    <?php
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Konfirmasi Peminjaman Offline</h4>
						</div>
                    </div>
                    <br/>
					<form action="pinjaman_offline_back.php" method="POST">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Id Buku </label>
							<div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="bk" placeholder="Id Buku"/>
							</div>
                        </div>
                        <div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label"></label>
							<div class="col-sm-12 col-md-10">
                                <a href="daftar_buku.php" style="margin-left:5px">Lihat daftar buku</a>
							</div>
						</div>
                        <div class="form-group row">
