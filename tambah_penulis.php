...
?>
    <title>Formulir Tambah Penulis</title>
    </head>
    <body>
    <?php
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix">
						<div class="pull-left">
							<h4 class="text-blue h4">Form Tambah Penulis</h4>
						</div>
                    </div>
                    <br/>
					<form action="pnl_back.php" method="POST">
						<div class="form-group row">
							<label class="col-sm-12 col-md-2 col-form-label">Nama Penulis </label>
							<div class="col-sm-12 col-md-10">
                                <input class="form-control" type="text" name="penulis" placeholder="Nama Penulis" />
							</div>
                        </div>
                        <div class="form-group row">
